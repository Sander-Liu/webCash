...
public class GoodsPutAwayServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            String sql = "insert into goods(name ,introduce,stock, " +
                    "unit,price,discount) values(?,?,?,?,?,?)";
            ...
            preparedStatement.setInt(5, Integer.valueOf(realPrice));
            preparedStatement.setInt(6, Integer.valueOf(discount));
            int ret = preparedStatement.executeUpdate();
            if (ret == 1) resp.sendRedirect("index.html");
